...
# Designed and developed by @insentodesu
...
def clear():
    ...
    messagebox.showinfo("Done","Vanillara1n files cleared")
...
def opentwitter():
    webbrowser.open('https://twitter.com/insentodesu', new=2)
...
def exitRecMode():
    if system_name == "posix":
        os.system("sh ./device/Linux/exitrecovery.sh")
    elif system_name == "darwin":
        os.system("sh ./device/Darwin/exitrecovery.sh")
    print("Kicking device out recovery mode...")
    


root.title('Vanillara1n bypass - Made by @insentodesu')
frame.pack()
...
mainText = Label(root, text="Vanillara1n bypass ",font=('Helveticabold', 24))
...
link = Label(root, text="Made this tool @insentodesu",font=('Helveticabold', 12), cursor="hand2")
link.place(x=165, y=220)
link.bind("<Button-1>", lambda e:
callback("https://twitter.com/insentodesu"))
